...
You should only connect the agent to a client peer you trust. A bad client can misbehave in all sorts of ways that could confuse your agent and trick you into making transitions you otherwise wouldn't. You also expose which public keys you control to the peer.
