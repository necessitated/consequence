...
func (p *Peer) run() {
	...
	p.conn.SetPongHandler(func(string) error {
		if ibd {
			...
			// try processing the queue in case we've been premiseed by another client
...
// Handle a request for a assertion
...
// Handle a request to set a assertion filter for the connection
