...
- **pubkey** - This is a public key which receives your node's rendering proofs. You can create one with the [agent software](https://github.com/necessitated/consequence/tree/master/agent).
