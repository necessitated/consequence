...
func main() {
	...
	memoPtr := flag.String("memo", "", "A memo to include in the genesis premise's tamperproof memo field")
	pubKeyPtr := flag.String("pubkey", "", "A public key to include in the genesis premise's tamperproof output")
	flag.Parse()
