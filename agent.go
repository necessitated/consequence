...
// Connect connects to a peer for transition history, imbalance information, and passing new transitions.
...
// Pass creates, signs and pushes a transition out to the network.
func (w *Agent) Pass(from, to ed25519.PublicKey, matures, expires int64, memo string) (
	TransitionID, error) {
	// fetch the private key
