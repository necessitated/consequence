...
Once the agentdb is initialized, you'll want to generate keys to send and receive transitions on the consequence network. This can be achieved with the `genkeys` command and entering the count of keys to generate (1 or more):
